...
qplot(vpr_depth_bin$avg_time_h, vpr_depth_bin$pressure, geom = 'line') +
...
p + geom_line(data = vpr_depth_bin, aes(x = avg_time_h, y = min_pressure), col = 'snow4', inherit.aes = FALSE) +
...
#sigma t contours
#interpolate data
  vpr_int <- akima::interp(x = vpr_depth_bin$avg_time_h, y = vpr_depth_bin$pressure, z = vpr_depth_bin$density)
...
#temperature
#interpolate data
vpr_int <- akima::interp(x = vpr_depth_bin$avg_time_h, y = vpr_depth_bin$pressure, z = vpr_depth_bin$temperature)
...
#salinity
#interpolate data
vpr_int <- akima::interp(x = vpr_depth_bin$avg_time_h, y = vpr_depth_bin$pressure, z = vpr_depth_bin$salinity)
